...
namespace ScannerPrototype.iOS.Implementation
{
    public class DatabaseFactory : IDatabaseFactory
    {
        ...
        private SQLiteAsyncConnection ConnectionAsync => _connectionAsync ?? (_connectionAsync = GetAsyncConnection());

        private SQLiteConnection Connection => _connection ?? (_connection = GetConnection());
